...
// Provider implements the user.Provider interface for CMON
...
// NewProvider creates a new CMON user provider
...
// GetUserInfo retrieves user information from CMON using a cmon-sid token
func (p *Provider) GetUserInfo(authCtx *user.AuthContext) (*user.User, error) {
	...
	// Extract cmon-sid cookie from request
